        ...
        <div class="col-12">
               <div class="card">
                <div class="card-header ">
                    <h1>Brand Listing
                       <a  href="javascript:void(0)" class="btn btn-sm btn-info float-right createbrand"  data-toggle="modal" data-target="#exampleModalCenter"> Create Brand</a>
                    </h1>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="brandForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <img src="{{ asset('admin/images/preview.jpg') }}" id="imagepreivew" name="imagepreivew" class="rounded float-left " alt="no image found" style="width: 100px; height: 100px; object-fit: cover;">
                            </div>
                    </div>
    ...
    $('#brandSave').on('click',function(e){
     ...
     if (response.errors) {
        ...
        if (response.errors.brandimage) {
            ...
            $('#brandimage_error').html(''); // Clear the error if no error exists
        }
    } else {
 ...
 $('body').on('click','.editbrand',function(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                var image = baseUrl + '/' + response.data.brand_image; // Dynamically append the image name
